...
# Test get_recently_played_tracks function
...
# Test get_playlist_for_mood function
...
# Test get_user_info with an invalid token
@patch("services.spotify_service.get_user_info")
...
# Test get_recently_played_tracks with empty response
@patch("services.spotify_service.get_recently_played_tracks")
